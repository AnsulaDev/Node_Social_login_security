...
app.use(passport.initialize()); //it sets up passport session
...
https.createServer({
    ...
    cert:fs.readFileSync('cert.pem'), //reading the certificate asynchronously before starting the server
},app).listen(PORT, () => {
